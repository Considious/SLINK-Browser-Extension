...
async function requireAdminPermission() {
  ...
  if (!SLINK.core.permissions.hasScope(permissions, 'admin.*')) {
    const error = new Error('admin.* permission is required to view diagnostics.');
    error.code = 'SLINK_ADMIN_REQUIRED';
    throw error;
  }
  return permissions;
}
